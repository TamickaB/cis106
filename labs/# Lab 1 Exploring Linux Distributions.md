...
**The Linux Distro that I chose is Predator-OS. This was made to be used by penetration testers and hackers. I like it because it has a lot of security. I would feel that my information is protected if I were using it. Most of all it is open source, so that means I get to use all of its tools for free. This distro can also be used for educational purposes.**
